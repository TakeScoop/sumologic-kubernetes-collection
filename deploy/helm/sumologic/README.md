...
`fluent-bit.rbac.create` | Specifies whether RBAC resources should be created. | `true`
`fluent-bit.rbac.pspEnabled` | Specifies whether a PodSecurityPolicy should be created. | `false`
